    ...
    <div className="flex h-screen">
      ...
      <div className="w-1/2 flex flex-col gap-5 items-center justify-center">
        <div className="w-[509px] h-[608px]  gap-5 flex flex-col items-center justify-center">
          ...
          {/* Form */}
          <form onSubmit={handelLogin} className="flex flex-col gap-3 !w-full !shadow-[0px] !p-0 max-w-md space-y-6">
            {/* Email */}
            <div>
            ...
            <p className="text-center text-[14px] font-sans text-gray-500 mt-6">
              Don't have account?{" "}
              <a href="/signup" className="text-lime-500 font-semibold hover:underline">
                Register Now
              </a>
            </p>
          </form>
